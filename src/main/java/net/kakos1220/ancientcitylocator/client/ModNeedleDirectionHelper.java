...
public abstract class ModNeedleDirectionHelper {
    private final boolean wobble;

    protected ModNeedleDirectionHelper(final boolean wobble) {
        this.wobble = wobble;
    }
    ...
    protected ModNeedleDirectionHelper.Wobbler newWobbler(final float factor) {
        return this.wobble ? standardWobbler(factor) : nonWobbler();
    }

    public static ModNeedleDirectionHelper.Wobbler standardWobbler(final float factor) {
        return new ModNeedleDirectionHelper.Wobbler() {
    ...
    public static ModNeedleDirectionHelper.Wobbler nonWobbler() {
        return new ModNeedleDirectionHelper.Wobbler() {
